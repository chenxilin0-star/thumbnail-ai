...
const styles = [
  { id: 'tech', name: '科技感', icon: '💻', color: 'bg-blue-500' },
  { id: 'gaming', name: '游戏风', icon: '🎮', color: 'bg-green-500' },
  { id: 'business', name: '商务风', icon: '💼', color: 'bg-slate-700' },
  { id: 'cute', name: '可爱风', icon: '🌸', color: 'bg-pink-400' },
  { id: 'dramatic', name: '震撼风', icon: '⚡', color: 'bg-red-500' },
]

const platforms = [
  { id: 'youtube', name: 'YouTube', size: '1280x720' },
  { id: 'bilibili', name: 'B站', size: '1920x1080' },
  { id: 'tiktok', name: '抖音', size: '1080x1920' },
]
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="简单描述视频内容，帮助 AI 生成更精准的封面"
                    rows={3}
                  />
                </div>
              </CardContent>
                    ...
                    {thumbnails.map((thumbnail, index) => (
                      <div key={index} className="relative group">
                        ...
                        <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                          <Button onClick={() => handleDownload(thumbnail)}>
